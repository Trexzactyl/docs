...
> **Note:** This encryption key is used to store important data (such as API keys).
...
Trezxactyl uses CLI commands to configure most of the base settings of the Panel.
...
with the `chown` command. Here's how to do this:
...
chown -R apache:apache /var/www/trexzactyl/*
```
