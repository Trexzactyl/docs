# Configure Discord for Trexzactyl

***

This guide will show you how to link a Discord auth application to Trexzactyl, which allows
users to authenticate with Trexzactyl via their Discord account.
...
![Discord ID image](/images/discord_id.png)
![Discord ID image 2](/images/discord_id_2.png)
...
![Discord Redirect image](/images/discord_redirect.png)

### Add Client ID and Secret to Trexzactyl

Finally, head over to Trexzactyl's 'User Registration' settings page and fill in your Client ID and Secret
for Discord. Make sure to enable the registration module, otherwise users will not be able to authenticate!
![Enable Trexzactyl image](/images/discord_trexzactyl.png)
